...
## 7. this generates message 'getting cached data' which suggests that prior calculation 
...
## data - an arbitrary invertible matrix 
...
## Inverted matrix I have calculated outside R: 
...
## R output - inverted matrix by cacheSolve(xx)
##      seq1 seq2  seq3  seq4 seq5 seq6 seq7  seq8 seq9 seq10
## [1,] -0.5  0.5 -0.25  0.25    0  1.5 -1.5  0.25 -0.5  8.75
## [2,] -1.5  2.5 -0.25 -0.75    0  1.5 -1.5  0.25 -0.5  8.75
## [3,]  1.5 -1.5  0.25 -0.25    0 -1.5  1.5 -0.25  0.5  -8.75
